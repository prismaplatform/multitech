          ...
          <div className="row">
            ...
            <div className="col-lg-7 d-flex align-items-center">
              <div className="lonyo-default-content pl-50" data-aos="fade-up" data-aos-duration="900">
                ...
                <p>As the Chief Executive Officer of Lonyo, Michael Chen brings over a decade of leadership and expertise in finance and technology. </p>
                <p>With a passion for innovation, he has been instrumental in shaping the company’s vision to empower individuals and businesses with smarter financial solutions. Under his guidance, Lonyo has grown into a trusted name in the finance software industry, known for its user-centric design, cutting-edge technology. </p>
                <p className="mb-0">Michael's strategic approach and dedication to fostering a culture of excellence have been key to the company's success. Michael enjoys mentoring young entrepreneurs and staying updated on the latest fintech trends to keep Lonyo ahead of the curve.</p>
            ...
            <div className="col-xl-4 col-lg-6">
              <div className="lonyo-team-d-content" data-aos="fade-up" data-aos-duration="500">
                ...
                <ul>
                  ...
                  <li><span>MBA in Finance and Business Strategy</span>– Graduated from a top-tier university with a specialization in financial management and corporate strategy.</li>
                  <li><span>Executive Leadership Training</span> – Completed advanced leadership programs from globally recognized institutions.</li>
                </ul>
              </div>
            </div>
            <div className="col-xl-4 col-lg-6">
              <div className="lonyo-team-d-content" data-aos="fade-up" data-aos-duration="700">
                <h4>Attributes:</h4>
                <ul>
                  <li><span>Visionary Leader</span> – Drives innovation long term success with strategic foresight.</li>
                  <li><span>Results-Oriented</span>– Focuses on achieving measurable outcomes & fostering growth.</li>
                  <li><span>Executive Leadership Training</span> – Thrives under pressure and leads challenges.</li>
