          ...
          <div className="row">
            <div className="col-xl-4 col-lg-6">
              <div className="multitech-team-d-content" data-aos="fade-up" data-aos-duration="500">
                ...
                <ul>
                  <li>
                    <span>Bachelor's Degree in Economics</span> – Strong foundation in economic
                    principles.
                  </li>
                  <li>
                    <span>MBA in Finance and Business Strategy</span>– Graduated from a top-tier
                    university with a specialization in financial management and corporate strategy.
                  </li>
                  <li>
                    <span>Executive Leadership Training</span> – Completed advanced leadership
                    programs from globally recognized institutions.
                  </li>
                </ul>
              </div>
            </div>
            <div className="col-xl-4 col-lg-6">
              <div className="multitech-team-d-content" data-aos="fade-up" data-aos-duration="700">
                ...
                <ul>
                  <li>
                    <span>Visionary Leader</span> – Drives innovation long term success with
                    strategic foresight.
                  </li>
                  <li>
                    <span>Results-Oriented</span>– Focuses on achieving measurable outcomes &
                    fostering growth.
                  </li>
                  <li>
                    <span>Executive Leadership Training</span> – Thrives under pressure and leads
                    challenges.
                  </li>
                  <li>
                    <span>Collaborative</span> – Encourages teamwork and cross-functional
                    communication.
                  </li>
                </ul>
              </div>
