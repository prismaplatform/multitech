          ...
          <div className="lonyo-integration-d-wrap">
            ...
            <div className="lonyo-default-content pb-35">
              ...
              <p>
                ...
                management for individuals and families. With its intuitive interface and powerful
                features, BudgetEase helps users gain control over their finances, track spending,
            ...
            <div className="lonyo-default-content pb-35">
              ...
              <div className="text text2">
                <p>
                  <span>1. Expense Tracking:</span> Automatically categorize and monitor spending to
                  identify areas where you can save.
                </p>
                <p>
                  <span>2. Smart Budgeting:</span> Set customizable budgets and receive real-time
                  updates to stay on track.
                </p>
                <p>
                  <span>3. Savings Goals:</span> Create and manage goals to build your emergency
                  fund or save for big purchases.
                </p>
                <p>
                  <span>4. Bill Reminders:</span> Never miss a due date with timely bill alerts and
                  tracking.
                </p>
                <p>
                  <span>5. Financial Insights:</span> Access detailed reports and charts to
            ...
            <div className="lonyo-default-content pb-35">
              ...
              <p>
                ...
                future through easy-to-use tools, personalized insights, and automation that
            ...
            <div className="lonyo-default-content border-b">
              ...
              <p>
                ...
                a stress-free way to budget, save, and achieve financial stability. With BudgetEase,
              ...
              <div className="lonyo-p-thumb thumb2" data-aos="fade-up" data-aos-duration="700">
                ...
                <div className="lonyo-p-data-wrap wrap2">
                  <div className="lonyo-p-content">
                    ...
                    <ul>
                      <li>
                        <Link href="/portfolio">Creative</Link>
                      </li>
                      <li>
                        <Link href="/portfolio">App</Link>
                      </li>
                    </ul>
                  </div>
