...
const IntegrationArea = () => {
  return (
    <>
      <div className="lonyo-section-padding7 section">
        <div className="integration-shape"></div>
        <div className="container">
          <div className="lonyo-section-title">
            <h2 className="max-w1000">Make all your tools work together seamlessly</h2>
          </div>
          <div className="row">
            <div className="col-xl-4 col-lg-6 col-md-6">
              <div className="lonyo-integration-wrap" data-aos="fade-up" data-aos-duration="500">
                <div className="lonyo-integration-content">
                  <h4>Texenzen</h4>
                  <p>Easily import and track online transactions from Texenzen.</p>
                ...
                <div className="lonyo-integration-icon">
                  <img src="/assets/images/integration/in1.svg" alt="" />
                </div>
              </div>
            </div>
            <div className="col-xl-4 col-lg-6 col-md-6">
              <div className="lonyo-integration-wrap" data-aos="fade-up" data-aos-duration="700">
                <div className="lonyo-integration-content">
                  <h4>MandamFlow</h4>
                  <p>Links with credit card accounts to monitor spending & payments.</p>
                  <Link className="title-btn" href="/single-integration">
                    Learn more
                    <svg
                      width="18"
                ...
                <div className="lonyo-integration-icon">
                  <img src="/assets/images/integration/in2.svg" alt="" />
                </div>
              </div>
            </div>
            <div className="col-xl-4 col-lg-6 col-md-6">
              <div className="lonyo-integration-wrap" data-aos="fade-up" data-aos-duration="900">
                <div className="lonyo-integration-content">
                  <h4>MindSyncer</h4>
                  <p>Automatically syncs with bank accounts to track transactions.</p>
                  <Link className="title-btn" href="/single-integration">
                    Learn more
                    <svg
                      width="18"
                ...
                <div className="lonyo-integration-icon">
                  <img src="/assets/images/integration/in3.svg" alt="" />
                </div>
              </div>
            </div>
            <div className="col-xl-4 col-lg-6 col-md-6">
            ...
            <div className="col-xl-4 col-lg-6 col-md-6">
              <div className="lonyo-integration-wrap" data-aos="fade-up" data-aos-duration="500">
                <div className="lonyo-integration-content">
                  <h4>DealTracker</h4>
                  <p>Allows users to capture all the receipts, categorize expenses.</p>
                  <Link className="title-btn" href="/single-integration">
                    Learn more
                    <svg
                      width="18"
                ...
                <div className="lonyo-integration-icon">
                  <img src="/assets/images/integration/in7.svg" alt="" />
                </div>
              </div>
            </div>
            <div className="col-xl-4 col-lg-6 col-md-6">
              <div className="lonyo-integration-wrap" data-aos="fade-up" data-aos-duration="700">
                <div className="lonyo-integration-content">
                  <h4>MarketInsight</h4>
                  <p>Integrates with tax software to simplify tax filing automatically.</p>
                  <Link className="title-btn" href="/single-integration">
                    Learn more
                    <svg
                      width="18"
                ...
                <div className="lonyo-integration-icon">
                  <img src="/assets/images/integration/in8.svg" alt="" />
                </div>
              </div>
            </div>
            <div className="col-xl-4 col-lg-6 col-md-6">
              <div className="lonyo-integration-wrap" data-aos="fade-up" data-aos-duration="900">
                <div className="lonyo-integration-content">
                  <h4>QuoteMaker</h4>
                  <p>Connects with payment gateways for tracking sales & transactions.</p>
                  <Link className="title-btn" href="/single-integration">
                    Learn more
                    <svg
                      width="18"
                ...
                <div className="lonyo-integration-icon">
                  <img src="/assets/images/integration/in9.svg" alt="" />
                </div>
              </div>
            </div>
          </div>
