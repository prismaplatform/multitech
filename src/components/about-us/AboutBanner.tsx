        ...
        <div className="container">
           <div className="row">
            <div className="col-lg-7">
              <div className="multitech-hero-dashbord h-100" data-aos="fade-right" data-aos-duration="700">
                <img src="/assets/images/about-us/about_section_multitech.jpg"  style={{borderRadius:"10px",objectFit:"cover",height:"100%"}} alt="" />
              </div>
            </div>
            <div className="col-lg-5">
              <div className="multitech-video-thumb2 h-100" data-aos="fade-left" data-aos-duration="700">
