     ...
     <div className={`${style_3 ? "lonyo-content-shape" : "lonyo-content-shape3"}`}>
      ...
      <footer
        className={`lonyo-footer-section ${
          style_2 ? "section2 bg-heading" : style_3 ? "" : "light-bg"
        }`}
          ...
          <div className="lonyo-footer-one">
            <div className="row">
              ...
              <div className="col-xxl-2 col-xl-4 col-md-6">
                <div
                  className={`lonyo-footer-menu pl-30 ${
                    style_2 ? "menu2" : ""
                  }`}
                >
                  <h4>Utility pages</h4>
            ...
            <div
              className={`${
                style_2 ? "lonyo-footer-shape2" : "lonyo-footer-shape"
              }`}
            ></div>
          </div>
