      ...
      <footer className={`lonyo-footer-section ${style_2 ? "section2 bg-heading" : style_3 ? "" : "light-bg"}`}>
        <div className="container">
                      ...
                      <li>
                        <a href="https://www.facebook.com">
                          <svg width="10" height="18" viewBox="0 0 9 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.61987 16.7464V9.37041H0.137695V6.49583H2.61987V4.37591C2.61987 1.91577 4.12245 0.576172 6.31707 0.576172C7.36832 0.576172 8.27181 0.654439 8.53511 0.689422V3.26042L7.01302 3.26111C5.81946 3.26111 5.58836 3.82827 5.58836 4.66054V6.49583H8.43488L8.06426 9.37041H5.58836V16.7464H2.61987Z" fill="#fff" />
                          </svg>
                        </a>
                      </li>
                      <li>
                  ...
                  <div className="lonyo-footer-menu-wrap">
                    ...
                    <div className="lonyo-footer-menu1">
                      <ul>
                        ...
                        <li>
                          <Link href="/single-blog">Blog single</Link>
                        </li>
                        <li>
                          <Link href="/integration">Integrations</Link>
                        </li>
                        <li>
                          <Link href="/single-integration">Integration single</Link>
                        </li>
                        <li>
              ...
              <div className="col-xxl-2 col-xl-4 col-md-6">
                <div className={`lonyo-footer-menu pl-30 ${style_2 ? "menu2" : ""}`}>
                  ...
                  <ul>
                    ...
                    <li>
                      <Link href="/cooming-soon">Coming soon</Link>
                    </li>
                    <li>
                ...
                <div className={`lonyo-footer-menu pl-31 mb-0 ${style_2 ? "menu2" : ""}`}>
                  ...
                  <div className={`${style_2 ? "lonyo-subscription-field3" : "lonyo-subscription-field2"}`}>
                    <form onSubmit={(e) => e.preventDefault()}>
                      ...
                      <button className={`lonyo-default-btn d-block ${style_2 ? "subscrib-btn2" : "subscrib-btn"}`} type="submit">Subscribe</button>
                    </form>
                  </div>
                </div>
              </div>
          ...
          <div className={`lonyo-footer-bottom-text ${style_2 ? "text2" : ""}`}>
            <p>© Copyright <span id="current-year">{new Date().getFullYear()}</span>, All Rights Reserved by Mthemeus</p>
          </div>
        </div>
      </footer>
